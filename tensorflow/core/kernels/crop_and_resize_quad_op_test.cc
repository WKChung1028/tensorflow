...
==============================================================================
same as crop_and_resize_test_ops
==============================================================================*/
...
class CropAndResizeQuadOpTest : public OpsTestBase {
 protected:
  template <typename T>
  void MakeOp(float extrapolation_value) {
    TF_EXPECT_OK(NodeDefBuilder("crop_and_resize_quad_op", "CropAndResizeQuad")
...
#define REGISTER_TEST(T)                                               \
  TEST_F(CropAndResizeQuadOpTest, TestCropAndResizeQuad##T) {                  \
    MakeOp<T>(0);                                                      \
...
TEST_F(CropAndResizeQuadOpTest, TestCropAndResizeQuad2x2To1x1Uint8) {
  MakeOp<uint8>(0);
  // Input:
  //  1, 2
  //  3, 4
...
TEST_F(CropAndResizQuadeOpTest, TestCropAndResizeQuad2x2To1x1Flipped) {
  MakeOp<float>(0);
  // Input:
  //  1, 2
  //  3, 4
...
TEST_F(CropAndResizeQuadOpTest, TestCropAndResizeQuad2x2To3x3) {
  MakeOp<float>(0);
  // Input:
  //  1, 2
  //  3, 4
...
TEST_F(CropAndResizeQuadOpTest, TestCropAndResizeQuad2x2To3x3Flipped) {
  MakeOp<float>(0);
  // Input:
  //  1, 2
  //  3, 4
...
TEST_F(CropAndResizeQuadOpTest, TestCropAndResizeQuad3x3To2x2) {
  MakeOp<float>(0);
  // Input:
  //  1, 2, 3
  //  4, 5, 6
...
TEST_F(CropAndResizQuadeOpTest, TestCropAndResizeQuad3x3To2x2Flipped) {
  MakeOp<float>(0);
  // Input:
  //  1, 2, 3
  //  4, 5, 6
...
TEST_F(CropAndResizeQuadOpTest, TestCropAndResizeQuad2x2To3x3Extrapolated) {
  const float v = -1;
  MakeOp<float>(v);
  // Input:
  //  1, 2
...
TEST_F(CropAndResizeQuadOpTest, TestCropAndResizeQuad2x2To3x3NoCrop) {
  MakeOp<float>(0);
  // Input:
  //  1, 2
  //  3, 4
...
TEST_F(CropAndResizeQuadOpTest, TestInvalidInputShape) {
  MakeOp<float>(0);
...
TEST_F(CropAndResizeQuadOpTest, TestInvalidBoxIndexShape) {
  MakeOp<float>(0);
  AddInputFromArray<float>(TensorShape({1, 2, 2, 1}), {1, 2, 3, 4});
  AddInputFromArray<float>(TensorShape({1, 4}), {0, 0, 1, 1});
  AddInputFromArray<int32>(TensorShape({2}), {0, 0});
...
TEST_F(CropAndResizeQuadOpTest, TestInvalidBoxIndex) {
  MakeOp<float>(0);
  AddInputFromArray<float>(TensorShape({1, 2, 2, 1}), {1, 2, 3, 4});
  AddInputFromArray<float>(TensorShape({1, 4}), {0, 0, 1, 1});
...
TEST_F(CropAndResizeQuadOpTest, TestWithSharding) {
  MakeOp<float>(0);
